define("AttributePlane", ["filter"], function(require, exports, module) {
    ...
    var initAttributePlane = function() {
        ...
        $nodeTree.on("mouseenter", function(e) {
            _self.focus();
            require("sketchpadManage").refreshLayerManager(e);
        ...
        var buttonEvents = {
            "edit": function(e) {
                prompt("请输入 " + _self.layerAttribute.name + " 的文字", _self.layerAttribute.text, function(newText) {
                    _self.layerAttribute.text = newText;
                	_self.reInit();
                })
            },
            "left": function(e) {
            ...
            "remove": function(e) {
                confirm("确定要删除 " + _self.layerAttribute.name + " 吗？", function(arg) {
                    if (arg) {
                        ...
                        console.log(_self);
                        _self.img.remove();
                        _self.layerControllerSet.remove();
                    }
                });
            }
        }
